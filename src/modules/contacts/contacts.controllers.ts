...
const {
  processCreateContactMessage,
  processDeleteContactMessage,
  processFindAllContactsMessages,
} = ContactsServices;
const ContactsControllers = {
  handleCreateContactMessage: async (
    req: Request,
    res: Response,
    next: NextFunction
  ) => {
  ...
  handleDeleteContactMessage: async (
    req: Request,
    res: Response,
    next: NextFunction
  ) => {
  ...
  handleFindAllContactsMessages: async (
    req: Request,
    res: Response,
    next: NextFunction
  ) => {
